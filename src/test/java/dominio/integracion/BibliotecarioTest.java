...
public class BibliotecarioTest {
	...
	public void prestarLibroTest() {
		...
		// act
		bibliotecario.prestar(libro.getIsbn(), "Usuario x","");
	...
	public void prestarLibroNoDisponibleTest() {
		...
		// act
		blibliotecario.prestar(libro.getIsbn(), "Usuario y", "24/06/2017");
		try {
			
			blibliotecario.prestar(libro.getIsbn(), "Usuario z", "26/06/2017");
			//fail(); 
